  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/9937644d-a6c5-48c6-9e03-2fefdf04148f/icon-mens-dri-fit-11-basketball-shorts-sD1bqF.png"
            thumbnail
          />
          <Row>
            <Col xs={4}>
              <Image
                src="https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/a2105143-1f3e-4734-932f-b91f45e33af1/icon-mens-dri-fit-11-basketball-shorts-sD1bqF.png"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/586d5bbd-1e28-4de9-a843-d4f809bf68ea/icon-mens-dri-fit-11-basketball-shorts-sD1bqF.png"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/3a73bc0e-23a9-4247-bf58-52fa824beb0c/icon-mens-dri-fit-11-basketball-shorts-sD1bqF.png"
                thumbnail
              />
            </Col>
          </Row>
            ...
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>
                      Take it to the hoop and beyond in these basketball
                      essentials. Our sweat-wicking Icon Shorts keep it light
                      and roomy with smooth fabric that's comfortable in all
                      phases of the game.
                    </p>
                  </td>
                </tr>
