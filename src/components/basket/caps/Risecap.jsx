...
export default function Riseblue() {
  ...
  const product = {
    id: 52,
    name: 'Jordan Rise Unisex Cap',
    price: 27.99,
    size: selectedSize,
    quantity: quantity,
    image:
      'https://www.bbbranded.com/cdn/shop/files/FD5181-436_PHSFM001_WIDTH_875_HEIGHT_875_FMT.jpg?v=1708536484&width=840',
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.bbbranded.com/cdn/shop/files/FD5181-436_PHSFM001_WIDTH_875_HEIGHT_875_FMT.jpg?v=1708536484&width=840"
            thumbnail
          />
          <Row>
            <Col xs={4}>
              <Image
                src="https://www.bbbranded.com/cdn/shop/files/FD5181-436_PHSYM001_WIDTH_875_HEIGHT_875_FMT.jpg?v=1708536484&width=840"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://www.bbbranded.com/cdn/shop/files/FD5181-436_PHSYM002_WIDTH_875_HEIGHT_875_FMT.jpg?v=1708536484&width=840"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://www.bbbranded.com/cdn/shop/files/FD5181-436_PHSYD002_WIDTH_875_HEIGHT_875_FMT.jpg?v=1708536484&width=840"
                thumbnail
              />
            </Col>
          </Row>
            ...
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>
                      You know exactly who you rep. Make sure everyone else does
                      too, in dad-hat style. A Jumpman logo on the crown of a
                      time-tested design leads with your Jordan spirit.
                      Adjustable back strap lets you find your perfect fit.
                      Embroidered eyelets let your head breathe. Woven patch
                      adds texture to your look.
                    </p>
                  </td>
                </tr>
              )}
