...
export default function Flinch() {
  ...
  const product = {
    id: 19,
    name: 'Basketball Dont Flinch Unisex Cap',
    price: 27.99,
    size: selectedSize,
    quantity: quantity,
    image:
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/0/2/023920_01.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
            thumbnail
          />
          <Row>
            <Col xs={4}>
            ...
            <Col xs={4}>
              <Image
                src="https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_600,h_600/global/023920/01/bv/fnd/AUS/fmt/png/Basketball-Don't-Flinch-Unisex-Cap"
                thumbnail
              />
            </Col>
          </Row>
            ...
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>
                      A celebration of PUMA's history on the courts, Don't
                      Flinch is for all the ballers and fans out there.{' '}
                    </p>
                  </td>
                </tr>
              )}
