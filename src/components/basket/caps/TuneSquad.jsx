...
export default function TuneSquad() {
  ...
  const product = {
    id: 62,
    name: 'Lebron Heritage86 Unisex Cap',
    price: 27.99,
    size: selectedSize,
    quantity: quantity,
    image:
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/d/m/dm3519-010-phsfh001-1000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
            thumbnail
          />
          <Row>
            <Col xs={4}>
            ...
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/d/m/dm3519-010-phsbh001-1000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
                thumbnail
              />
            </Col>
          </Row>
            ...
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>
                      Top it off with the LeBron Heritage86 cap from Nike
                      Basketball. It has an unstructured cotton twill crown with
                      an adjustable strap and a shaped peak.
                    </p>
                  </td>
                </tr>
              )}
