...
export default function Curved() {
  ...
  const product = {
    id: 11,
    name: 'Unisex Nba Curved Structured Cap',
    price: 27.99,
    size: selectedSize,
    quantity: quantity,
    image:
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/n/b/nbasb521201-wht_frontf1-001.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
            thumbnail
          />
          <Row>
            <Col xs={4}>
            ...
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/n/b/nbasb521201-wht_frontf2-002.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/n/b/nbasb521201-wht_backf1-001.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
                thumbnail
              />
            </Col>
          </Row>
