...
export default function YellowCap() {
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/f/d/fd5185-752_phsfm001-1000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
            thumbnail
          />
          <Row>
            <Col xs={4}>
            ...
            <Col xs={4}>
              <Image
                src="https://bouncewear.com/cdn/shop/files/AURORA_FD5185-752_PHSBM001-1000.png?v=1703256942&width=1024"
                thumbnail
              />
            </Col>
          </Row>
            ...
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>
                      You new everyday dad hat has landed. This six-panel design
                      features an unstructured, low-profile crown, curved brim
                      and adjustable snapback closure. It's all brought together
                      with an understated Jumpman graphic on the front.
                      Embroidered graphic adds texture to your look. Sweatband
                      provides a cool, comfortable feel. Adjustable snapback
                      closure provides a personalized fit.
                    </p>
                  </td>
                </tr>
              )}
