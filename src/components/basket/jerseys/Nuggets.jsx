...
export default function Nuggets() {
  ...
  const product = {
    id: 47,
    name: 'Unisex Denver Nuggets Nikola Jokic Nike Navy Swingman Jersey - Icon Edition',
    price: 99.99,
    size: selectedSize,
    quantity: quantity,
    image:
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://fanatics.frgimages.com/denver-nuggets/unisex-nike-nikola-jokic-navy-denver-nuggets-swingman-jersey-icon-edition_ss5_p-4650405+pv-1+u-8tdkk3zua3ddan4ecrgv+v-nqfk542jtuvjak7ycxa6.jpg?_hv=2&w=900"
            thumbnail
          />
          <Row>
            <Col xs={4}>
            ...
            <Col xs={4}>
              <Image
                src="https://fanatics.frgimages.com/denver-nuggets/unisex-nike-nikola-jokic-navy-denver-nuggets-swingman-jersey-icon-edition_ss5_p-4650405+pv-2+u-8tdkk3zua3ddan4ecrgv+v-bbevifn7yfnemnzhydzg.jpg?_hv=2&w=900"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://fanatics.frgimages.com/denver-nuggets/unisex-nike-nikola-jokic-navy-denver-nuggets-swingman-jersey-icon-edition_ss5_p-4650405+pv-3+u-8tdkk3zua3ddan4ecrgv+v-zgdfknomxgovyhp0n4fv.jpg?_hv=2&w=900"
                thumbnail
              />
            </Col>
          </Row>
            ...
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>
                      Capture your team's distinct identity in a new and
                      innovative design when you grab this Nikola Jokic Denver
                      Nuggets Association Edition Swingman Jersey from Nike.
                      Directly inspired by the team's on-court look, it features
                      classic trim and Denver Nuggets graphics along with Nike's
                      Dri-FIT technology for added comfort. Before you head to
                      the next Denver Nuggets game, grab this incredible jersey
                      so everyone knows your fandom is on the cutting edge.
                    </p>
                  </td>
                </tr>
              )}
