...
export default function Larry() {
  ...
  const product = {
    id: 40,
    name: "Men's Boston Celtics Larry Bird Mitchell & Ness Kelly Green Hardwood Classics Swingman Jersey",
    price: 99.99,
    size: selectedSize,
    quantity: quantity,
    image:
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://fanatics.frgimages.com/boston-celtics/mens-mitchell-and-ness-larry-bird-kelly-green-boston-celtics-hardwood-classics-swingman-jersey_pi2751000_altimages_ff_2751337alt1_full.jpg?_hv=2&w=900"
            thumbnail
          />
          <Row>
            <Col xs={4}>
            ...
            <Col xs={4}>
              <Image
                src="https://fanatics.frgimages.com/boston-celtics/mens-mitchell-and-ness-larry-bird-kelly-green-boston-celtics-hardwood-classics-swingman-jersey_pi2751000_altimages_ff_2751337alt2_full.jpg?_hv=2&w=900"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://fanatics.frgimages.com/boston-celtics/mens-mitchell-and-ness-larry-bird-kelly-green-boston-celtics-hardwood-classics-swingman-jersey_pi2751000_altimages_ff_2751337alt3_full.jpg?_hv=2&w=900"
                thumbnail
              />
            </Col>
          </Row>
            ...
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>
                      Rep one of your all-time favorite pros with this Larry
                      Bird Swingman jersey from Mitchell & Ness. The throwback
                      Boston Celtics details are inspired by the franchise's
                      iconic look of days gone by. Every stitch on this jersey
                      is tailored to exact team specifications, delivering
                      outstanding quality and a premium feel.
                    </p>
                  </td>
                </tr>
              )}
