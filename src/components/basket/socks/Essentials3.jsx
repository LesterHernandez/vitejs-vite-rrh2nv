...
export default function Essentials3() {
  ...
  const product = {
    id: 17,
    name: 'Jordan Essentials Crew 3-Pack Unisex Tights',
    price: 29.99,
    size: selectedSize,
    quantity: quantity,
    image:
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/d/a/da5718-100-phcfh001-2000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
            thumbnail
          />
          <Row>
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/d/a/da5718-100-phcyd001-2000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/d/a/da5718-100-phcyd002-2000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/d/a/da5718-100-phsyd001-2000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
                thumbnail
              />
            </Col>
          </Row>
            ...
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>
                      The Jordan Essentials Crew Socks are soft and stretchy,
                      with a supportive fit and woven cushioning underfoot. 3
                      pairs sets you up for almost half the week. Sweat-wicking
                      technology helps keep you dry and comfortable. Knit
                      cushioning adds softness underfoot. Arch band offers a
                      snug, secure fit.
                    </p>
                  </td>
                </tr>
