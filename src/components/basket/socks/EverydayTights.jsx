...
export default function EverydayTights() {
  ...
  const product = {
    id: 18,
    name: 'Jordan Everyday Unisex Tights',
    price: 29.99,
    size: selectedSize,
    quantity: quantity,
    image:
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/d/x/dx9655-917_phcfh001-1000.jpeg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
            thumbnail
          />
          <Row>
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/d/x/dx9655-917_phcyd002-1000.jpeg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/d/x/dx9655-917_phsyd001-1000.jpeg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/d/x/dx9655-917_phcyd001-1000.jpeg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
                thumbnail
              />
            </Col>
          </Row>
            ...
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>
                      These ankle socks keep you dry and cool with sweat-wicking
                      fabric and breathable ankle panels. They are fitted around
                      the arch to offer support.
                    </p>
                  </td>
                </tr>
              )}
