...
export default function Pball() {
  ...
  const product = {
    id: 49,
    name: 'Nike Playground 8P 2.0 James',
    price: 51.15,
    size: selectedSize,
    quantity: quantity,
    image:
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/n/1/n100437257507-frontf1-001.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
            thumbnail
          />
          <Row>
            <Col xs={4}>
            ...
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>
                      NIKE PLAYGROUND 8P 2.0 L JAMES is a new product from the
