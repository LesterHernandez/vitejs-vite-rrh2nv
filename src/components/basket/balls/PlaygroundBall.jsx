...
export default function PlaygroundBall() {
  ...
  const product = {
    id: 50,
    name: 'Nike Everyday Playground 8P Gr',
    price: 51.15,
    size: selectedSize,
    quantity: quantity,
    image:
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/n/1/n100437103907-frontf1-001.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
            thumbnail
          />
          <Row>
            <Col xs={4}>
            ...
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>
                      Nike Everyday Playground 8P Gr is a new product from the
                      Nike brand. We also invite you to learn more products from
                      your favorite brands on our website.
                    </p>
                  </td>
                </tr>
              )}
