...
export default function Deflate() {
  ...
  const product = {
    id: 14,
    name: 'Balón Ultimate 2.0 8P Deflate Unisex',
    price: 51.15,
    size: selectedSize,
    quantity: quantity,
    image:
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/j/1/j1008254855-frontf1-001.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
            thumbnail
          />
          <Row>
            <Col xs={4}>
            ...
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>
                      ULTIMATE 2.0 8P DEFLATE is a new product from Jordan
                      brand. We also invite you to learn more products from your
                      favorite brands on our website.
                    </p>
                  </td>
                </tr>
              )}
