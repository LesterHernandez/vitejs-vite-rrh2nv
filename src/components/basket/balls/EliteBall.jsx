...
export default function EliteBall() {
  ...
  const product = {
    id: 16,
    name: 'Nike Elite All Court 8P 2.0',
    price: 51.15,
    size: selectedSize,
    quantity: quantity,
    image:
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/n/1/n1004088855-frontf1-001.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
            thumbnail
          />
          <Row>
            <Col xs={4}>
            ...
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>
                      NIKE ELITE ALL COURT 8P 2.0 DE is a new product from the
