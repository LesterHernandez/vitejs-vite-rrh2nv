...
export default function AttacantoShin() {
  ...
  const product = {
    id: 162,
    name: "Attacanto Sleeve Unisex Shin Guards",
    price: 31.90,
    size: selectedSize,
    quantity: quantity,
    image: "https://www.sportline.com.gt/media/catalog/product/0/3/030887-02_global.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/0/3/030887-02_global.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
            thumbnail
          />
        </Col>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>Stay protected and agile on the field with the Attacanto Sleeve Unisex Shin Guards. These shin guards are designed for lightweight comfort and reliable protection during intense play. Featuring a streamlined sleeve design, they offer a secure fit and minimal interference with your movement. The durable shell provides impact resistance, while the foam backing enhances cushioning and comfort. Ideal for both training sessions and matches, the Attacanto Sleeve Unisex Shin Guards ensure you can focus on your game without distraction. Elevate your performance and confidence with these essential football accessories.</p>
                  </td>
                </tr>
              )}
              <tr>
