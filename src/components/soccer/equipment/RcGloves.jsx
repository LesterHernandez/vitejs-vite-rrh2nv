...
export default function RcGloves() {
  ...
  const product = {
    ...
    size: selectedSize,
    quantity: quantity,
    image: "https://www.sportline.com.gt/media/catalog/product/0/4/041862-08_global.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/0/4/041862-08_global.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
            thumbnail
          />
        </Col>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>Master the field with the Puma Ultra Play RC Unisex Gloves in pink. Designed to deliver optimal performance, these gloves combine exceptional durability, grip, and comfort. Equipped with durable latex palms, they provide superior grip and cushioning to confidently handle every shot. Their lightweight construction and flexible material ensure optimal mobility, while the adjustable wrist strap offers a secure and personalized fit. Whether in training or competition, these gloves deliver the reliability and performance needed to excel as a goalkeeper. Get ready to stand out in every game with the Puma Ultra Play RC Unisex Gloves.</p>
                  </td>
                </tr>
              )}
              <tr>
