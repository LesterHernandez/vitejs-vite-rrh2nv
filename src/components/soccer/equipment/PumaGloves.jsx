...
export default function PumaGloves() {
  ...
  const product = {
    id: 158,
    name: "Puma Ultra Grip 3 Rc Unisex Goalkeeper Gloves",
    price: 31.90,
    size: selectedSize,
    quantity: quantity,
    image: "https://www.sportline.com.gt/media/catalog/product/0/4/041816_05.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/0/4/041816_05.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
            thumbnail
          />
          <Row>
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/0/4/041816_05_1.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/0/4/041816_05_mod01.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/0/4/041816_05_mod03.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
                thumbnail
              />
            </Col>
          </Row>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>PUMA ULTRA GRIP 3 RC / GL is a new product from the Puma brand. Swipe to view the images and appreciate more details from different angles. We also invite you to discover more products from your favorite brands on our website.</p>
                  </td>
                </tr>
              )}
              <tr>
