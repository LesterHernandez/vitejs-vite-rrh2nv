...
export default function GlovesUltra() {
  ...
  const product = {
    id: 156,
    name: "Puma Ultra Play Rc Unisex Gloves.",
    price: 31.90,
    size: selectedSize,
    quantity: quantity,
    image: "https://www.sportline.com.gt/media/catalog/product/0/4/041862-10_global.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/0/4/041862-10_global.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
            thumbnail
          />
        </Col>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>Elevate your game with the Puma Ultra Play RC Unisex Gloves. Engineered for performance and comfort, these gloves are designed to enhance your grip and control on the field. Featuring durable latex palms, they provide superior grip and cushioning to handle every shot and save with confidence. The lightweight construction and flexible material ensure optimal mobility, while the adjustable wrist strap offers a secure and personalized fit. Whether you're training or competing, these gloves deliver the reliability and performance you need to excel as a goalkeeper. Gear up with the Puma Ultra Play RC Unisex Gloves and dominate the game with style and precision.</p>
                  </td>
                </tr>
              )}
              <tr>
