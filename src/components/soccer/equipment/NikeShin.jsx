...
export default function NikeShin() {
  ...
  const product = {
    id: 165,
    name: "Nike Charge Unisex Shin Guards",
    price: 31.90,
    size: selectedSize,
    quantity: quantity,
    image: "https://www.sportline.com.gt/media/catalog/product/d/x/dx4610-010_phcfz001-1000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/d/x/dx4610-010_phcfz001-1000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
            thumbnail
          />
        </Col>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>Stay protected and focused on the game with the Nike Charge Unisex Shin Guards. Designed for reliable impact resistance and comfort, these shin guards feature a durable, hard shell that absorbs shocks during intense play. The anatomical design and foam padding offer a snug fit and cushioning for enhanced comfort. Adjustable straps ensure a secure, personalized fit, while the lightweight construction allows for unrestricted movement on the field. Whether you're training or competing, the Nike Charge Unisex Shin Guards provide essential protection and support for every match.</p>
                  </td>
                </tr>
              )}
              <tr>
