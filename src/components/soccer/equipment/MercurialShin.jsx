...
export default function MercurialShin() {
  ...
  const product = {
    id: 163,
    name: "Nike Mercurial Lite Unisex Shin Guards",
    price: 31.90,
    size: selectedSize,
    quantity: quantity,
    image: "https://www.sportline.com.gt/media/catalog/product/d/n/dn3611-101_phcfz001-1000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/d/n/dn3611-101_phcfz001-1000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
            thumbnail
          />
        </Col>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>Enhance your game with the Nike Mercurial Lite Unisex Shin Guards. Engineered for speed and protection, these shin guards feature a low-profile, anatomical design that contours to the shape of your leg for a snug fit and minimal distraction. The lightweight shell offers durable yet flexible protection against impacts, while the dense foam backing provides cushioning and comfort. Designed to stay securely in place with a breathable sleeve and elasticated strap, these shin guards ensure freedom of movement and confidence on the field. Whether you're training or competing, the Nike Mercurial Lite Unisex Shin Guards are essential for staying agile and protected throughout the match.</p>
                  </td>
                </tr>
              )}
              <tr>
