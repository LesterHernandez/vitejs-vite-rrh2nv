...
export default function LwcBackpack() {
  ...
  const product = {
    id: 139,
    name: "Umbro Backpack 30895U-Lwc Unisex",
    price: 31.50,
    size: selectedSize,
    quantity: quantity,
    image: "https://soccermaniaguate.com/image/cache/catalog/30867U-U56-800x800.jpg"
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://soccermaniaguate.com/image/cache/catalog/30867U-U56-800x800.jpg"
          />
          <Row>
            <Col xs={4}>
              <Image
                src="https://soccermaniaguate.com/image/cache/catalog/30867U-U56--150x150.jpg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://soccermaniaguate.com/image/cache/catalog/30867U-U56-2-150x150.jpg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>Discover practicality and style with the Umbro Backpack 30895U-Lwc, designed to meet your everyday needs with ease. This unisex backpack combines functionality with a sleek design, featuring multiple compartments for efficient organization of your essentials. The durable fabric ensures longevity, while the adjustable padded shoulder straps offer comfort during extended wear. Perfect for work, school, or casual outings, it includes a padded laptop sleeve to securely carry your tech devices. The Umbro logo adds a touch of sporty elegance, making this backpack a versatile and reliable companion for your daily adventures.</p>
                  </td>
                </tr>
              )}
              <tr>
