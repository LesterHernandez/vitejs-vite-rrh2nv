...
export default function PumaMS() {
  ...
  const product = {
    id: 125,
    name: "Puma Ms Ball S5",
    price: 51.15,
    size: selectedSize,
    quantity: quantity,
    image: "https://www.sportline.com.gt/media/catalog/product/0/8/083765_01.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/0/8/083765_01.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:"
            thumbnail
          />
        </Col>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>At PUMA, we know that the right gear can make all the difference. Now you can train like the football legends you idolize with our MS Football. This ball features a traditional 32-panel machine-stitched body adorned with bold, modern graphics for supreme style while you play.</p>
                  </td>
                </tr>
              )}
              <tr>
