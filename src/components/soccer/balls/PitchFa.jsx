...
export default function PitchFa() {
  ...
  const product = {
    id: 126,
    name: "Nike Pitch - Fa22",
    price: 51.15,
    size: selectedSize,
    quantity: quantity,
    image: "https://www.sportline.com.gt/media/catalog/product/d/n/dn3600-701_phsbz001-1000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
  };
      ...
      <Row>
        ...
        <Col xs={6}>
          <Row>
            <Col xs={10}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/d/n/dn3600-701_phsbz001-1000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
                thumbnail
              />
            </Col>
          </Row>
          <Row>
            <Col xs={10}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/d/n/dn3600-701_phsfz001-1000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
                thumbnail
              />
            </Col>
          </Row>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>Get ready to score with the Nike Pitch soccer ball. It features high-contrast graphics for better visibility during both games and practice, while its durable design ensures it performs consistently with every kick.</p>
                  </td>
                </tr>
              )}
              <tr>
