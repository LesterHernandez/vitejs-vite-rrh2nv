...
export default function GuateBall() {
  ...
  const product = {
    id: 120,
    name: "Guatemala Ball Unisex",
    price: 51.15,
    size: selectedSize,
    quantity: quantity,
    image: "https://siman.vtexassets.com/arquivos/ids/5270429/104388192--2-.jpg?v=638457609246870000"
  };
      ...
      <Row>
        ...
        <Col xs={6}>
          <Row>
            <Col xs={10}>
              <Image
                src="https://siman.vtexassets.com/arquivos/ids/5270429/104388192--2-.jpg?v=638457609246870000"
                thumbnail
              />
            </Col>
          </Row>
          <Row>
            <Col xs={10}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/2/7/27051u-928_backf1-001.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
                thumbnail
              />
            </Col>
          </Row>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>Show your pride for Guatemala with this Umbro club ball, featuring the national team's crest. Its high-quality construction offers exceptional durability and a soft touch, making it perfect for both practice and competitive play. The advanced stitching technology ensures optimal shape retention, while the butyl bladder keeps it reliably inflated. Designed for performance, the ball's textured surface enhances grip and control, allowing you to emulate your favorite Guatemalan football heroes on the field. Ideal for players of all levels, this ball embodies the spirit and passion of Guatemalan soccer.</p>
                  </td>
                </tr>
              )}
              <tr>
