...
export default function AcademyBall() {
  ...
  const product = {
    id: 124,
    name: "Nike Academy Ball",
    price: 51.15,
    size: selectedSize,
    quantity: quantity,
    image: "https://www.sportline.com.gt/media/catalog/product/c/u/cu8047-102-phsfz001-2000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/c/u/cu8047-102-phsfz001-2000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
            thumbnail
          />
          <Row>
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/c/u/cu8047-102-phsbz001-2000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/c/u/cu8047-102-phsfz001-2000_1.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/c/u/cu8047-102-phsbz001-2000_1.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
                thumbnail
              />
            </Col>
          </Row>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>The Nike Academy soccer ball features innovative grooves designed for consistent spin when the ball is in the air. High-contrast graphics help you easily track the ball. Nike Aerowsculpt technology uses molded grooves for more consistent flight. The reinforced rubber bladder helps maintain air pressure and shape.</p>
                  </td>
                </tr>
              )}
              <tr>
