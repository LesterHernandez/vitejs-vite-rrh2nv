...
export default function Barcelona() {
  ...
  const product = {
    id: 112,
    name: "FC Barcelona home kit season 2023/24",
    price: 51.15,
    size: selectedSize,
    quantity: quantity,
    image: "https://fanpass.do/cdn/shop/files/Group3569_800x.png?v=1696455073"
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://fanpass.do/cdn/shop/files/Group3569_800x.png?v=1696455073"
            thumbnail
          />
          <Row>
            <Col xs={4}>
              <Image
                src="https://images.prodirectsport.com/ProductImages/Gallery_3/286175_Gallery_3_1416159.jpg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/d/x/dx2761-456_phsbh001-1000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/d/x/dx2761-456_phsym002-1000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
                thumbnail
              />
            </Col>
          </Row>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>The FC Barcelona 2023/24 kit pays tribute to the 30th anniversary of the incorporation of the women's team into the club. The crest features a hidden diamond shape that was historically used by the women's team, and the classic stripes have a diamond pattern along the edges. Our Stadium collection combines replica design details with sweat-wicking technology to give you a game-ready look inspired by your favorite team.</p>
                  </td>
                </tr>
              )}
              <tr>
