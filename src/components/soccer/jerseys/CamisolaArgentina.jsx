...
export default function CamisolaArgentina() {
  ...
  const product = {
    id: 110,
    name: "Argentina's host team jersey, world champion 2022",
    price: 51.15,
    size: selectedSize,
    quantity: quantity,
    image: "https://i.postimg.cc/wxf2kVSY/camisola-Arg1.avif"
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://i.postimg.cc/wxf2kVSY/camisola-Arg1.avif"
            thumbnail
          />
          <Row>
            <Col xs={4}>
              <Image
                src="https://i.postimg.cc/1RvnTR0L/camisola-Arg2.avif"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://i.postimg.cc/y6phRyGg/camisola-Arg3.avif"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://i.postimg.cc/L4PfqFj7/camisola-Arg4.avif"
                thumbnail
              />
            </Col>
          </Row>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>Celebrate Argentina's triumph with the Argentina Home Team Jersey, World Champion 2022 edition. This jersey is a tribute to the team's incredible victory and features the iconic blue and white stripes that represent Argentina's rich football heritage. Crafted with high-quality materials, it offers superior comfort and durability for both on and off the pitch. The jersey includes the official team crest and a special World Champion 2022 badge, commemorating their historic win. Designed for passionate fans, this jersey allows you to show your support with pride and style. Wear the Argentina Home Team Jersey and feel the glory of being a world champion.</p>
                  </td>
                </tr>
              )}
              <tr>
