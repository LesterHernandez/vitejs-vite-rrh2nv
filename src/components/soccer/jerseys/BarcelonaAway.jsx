...
export default function BarcelonaAway() {
  ...
  const product = {
    id: 113,
    name: "FC Barcelona away kit season 2023/24",
    price: 51.15,
    size: selectedSize,
    quantity: quantity,
    image: "https://jerseyloco.com/wp-content/uploads/2023/08/2324-Barcelona-Away-Jersey.jpg"
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://images.prodirectsport.com/ProductImages/Main/286819_Main_Thumb_1744785.jpg"
            thumbnail
          />
          <Row>
            <Col xs={4}>
              <Image
                src="https://images.prodirectsport.com/ProductImages/Gallery_2/286819_Gallery_2_1744787.jpg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://images.prodirectsport.com/ProductImages/Gallery_2/1003429_Gallery_2_1744858.jpg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/d/x/dx2686-101_phsfh001-1000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
                thumbnail
              />
            </Col>
          </Row>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>Yes, Barcelona has a white kit. No, this is not a mistake. The 2023/24 away jersey is inspired by the white kit used by the club in 1978 and pays homage to the greats of the game. The crest on the jersey is the same one used in '78, and the ribbed sleeve details honor the legendary captain of that team. Our Stadium collection combines replica design details with sweat-wicking technology to give you a game-ready look inspired by your favorite team.</p>
                  </td>
                </tr>
              )}
              <tr>
