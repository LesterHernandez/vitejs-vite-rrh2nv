...
export default function Liverpool() {
  ...
  const product = {
    id: 118,
    name: "Liverpool FC Home kit 2023/24",
    price: 51.15,
    size: selectedSize,
    quantity: quantity,
    image: "https://stefanssoccer.com/mm5/graphics/00000001/9/AURORA_DX2692-688_PHSFH001-2000.jpg"
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://stefanssoccer.com/mm5/graphics/00000001/9/AURORA_DX2692-688_PHSFH001-2000.jpg"
            thumbnail
          />
          <Row>
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/d/x/dx2692-688_phsym001-1000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/d/x/dx2692-688_phsfm001-1000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://www.sportline.com.gt/media/catalog/product/d/x/dx2692-688_phsym004-1000.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
                thumbnail
              />
            </Col>
          </Row>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>Filled with details, the Liverpool FC 2023/24 jersey commemorates the 97 people who tragically lost their lives in the Hillsborough disaster. A '97' between two eternal flames resides on the inner pride, while white accents on the collar and sleeves pay homage to a jersey worn by the legendary 1974 team. Our Stadium collection combines replica design details with sweat-wicking technology to give you a game-ready look inspired by your favorite team.</p>
                  </td>
                </tr>
              )}
              <tr>
