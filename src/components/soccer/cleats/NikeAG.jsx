...
export default function NikeAG() {
  ...
  const product = {
    id: 106,
    name: "Nike Tiempo Legend X Elite AG",
    price: 77.97,
    size: selectedSize,
    quantity: quantity,
    image: "https://images.prodirectsport.com/ProductImages/Main/1016243_Main_1809209.jpg"
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://images.prodirectsport.com/ProductImages/Main/1016243_Main_1809209.jpg"
            thumbnail
          />
          <Row>
            <Col xs={4}>
              <Image
                src="https://images.prodirectsport.com/ProductImages/Main/1015928_Main_1784065.jpg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://images.prodirectsport.com/ProductImages/Gallery_2/1015928_Gallery_2_1784070.jpg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://images.prodirectsport.com/ProductImages/Gallery_4/1015928_Gallery_4_1784072.jpg"
                thumbnail
              />
            </Col>
          </Row>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>Make the game look easy wearing Nike Tiempo Legend X Elite AG football boots in Pink Foam/Black, featuring a moulded, engineered upper for effortless touch.
                    Created for confident, positive play, the Tiempo Legend X is the sleekest, most attacking Tiempo yet. Wherever you find yourself on the pitch, the soft FlyTouch+ upper provides the comfort and close feel on the ball you need to stay calm and in control. We’re talking shimmies in your own six-yard box, passes under pressure in midfield, and perfect finesse shots up front. Composure stats maxed out. Its fully engineered design is softer than natural leather and features streamlined foam pods, smoothed down into the moulded lines of the boot to dampen your touch just the right amount. The material won’t overstretch and requires zero break-in time. Basically, you get all the benefits of leather with none of the downsides. 3D microdot touch zones amplify control, while ever-reliable ACC ensures your touch stays immaculate in all weather conditions. At the heel, an integrated Flyknit collar combines with interior padding to keep you locked in and minimise irritation. </p>
                  </td>
                </tr>
              )}
              <tr>
