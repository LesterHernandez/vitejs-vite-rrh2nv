...
export default function NikeLegend() {
  ...
  const product = {
    id: 105,
    name: "Nike Tiempo Legend X Elite FG",
    price: 77.97,
    size: selectedSize,
    quantity: quantity,
    image: "https://images.prodirectsport.com/ProductImages/Main/1001601_Main_Thumb_1427867.jpg"
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://images.prodirectsport.com/ProductImages/Main/1001601_Main_Thumb_1427867.jpg"
            thumbnail
          />
          <Row>
            <Col xs={4}>
              <Image
                src="https://images.prodirectsport.com/ProductImages/Gallery_1/1001601_Gallery_1_1427868.jpg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://images.prodirectsport.com/ProductImages/Gallery_5/1001601_Gallery_5_1427874.jpg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://images.prodirectsport.com/ProductImages/Gallery_3/1001601_Gallery_3_1427870.jpg"
                thumbnail
              />
            </Col>
          </Row>
