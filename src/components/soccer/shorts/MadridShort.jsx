...
export default function MadridShort() {
  ...
  const product = {
    id: 134,
    name: "Real Madrid Home Shorts 2023/24",
    price: 29.99,
    size: selectedSize,
    quantity: quantity,
    image: "https://www.soccerbox.com/media/catalog/product/cache/e5c18d5f608fefb2b3ef83fcb1922b34/r/e/real-madrid-home-shorts-23.jpg"
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.soccerbox.com/media/catalog/product/cache/e5c18d5f608fefb2b3ef83fcb1922b34/r/e/real-madrid-home-shorts-23.jpg"
            thumbnail
          />
          <Row>
            <Col xs={4}>
              <Image
                src="https://soccermaniaguate.com/image/cache/catalog/HR37933APPARELOn-ModelStandard-Viewtransparent-150x150.jpg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://soccermaniaguate.com/image/cache/catalog/HR37936APPARELOn-ModelDetail-View-1transparent-150x150.jpg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://soccermaniaguate.com/image/cache/catalog/HR37934APPARELOn-ModelBack-Viewtransparent-150x150.jpg"
                thumbnail
              />
            </Col>
          </Row>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>Celebrating elegance on the field. These adidas Real Madrid shorts are part of a classic home kit and feature the club's crest woven on the iconic white color. Designed for the club's fans, they envelop you in comfort with their soft and cozy fabric.</p>
                    <ul>
                      <li>Classic fit.</li>
                      <li>Elastic waistband with drawstring.</li>
                      <li>100% recycled polyester interlock fabric.</li>
                    </ul>
                  </td>
                </tr>
              )}
