...
export default function ChelseaShort() {
  ...
  const product = {
    id: 136,
    name: "CHELSEA AWAY SHORTS 2021/22",
    price: 29.99,
    size: selectedSize,
    quantity: quantity,
    image: "https://www.soccerbox.com/media/catalog/product/cache/f4b6407e5847ea579fdc5730945961f6/c/h/chelsea-21-22-away-shorts-front_1.jpg"
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.soccerbox.com/media/catalog/product/cache/f4b6407e5847ea579fdc5730945961f6/c/h/chelsea-21-22-away-shorts-front_1.jpg"
            thumbnail
          />
          <Row>
            <Col xs={4}>
              <Image
                src="https://www.sportsdirect.com/images/products/37228903_l_a3.jpg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://www.sportsdirect.com/images/products/37228903_l_a2.jpg"
                thumbnail
              />
            </Col>
            <Col xs={4}>
              <Image
                src="https://www.sportsdirect.com/images/products/37228903_l_a1.jpg"
                thumbnail
              />
            </Col>
          </Row>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>These Junior CFC Away Shorts for the 21/22 season has been developed with Nike Breathe fabric and Dri-Fit technology which work together to deliver the perfect combination of moisture wicking comfort and cooling breathability. The shorts have an elasticated waist and drawstring fastening for a snug fit, while the team crest and Nike Swoosh branding completes the design.</p>
                  </td>
                </tr>
              )}
              <tr>
