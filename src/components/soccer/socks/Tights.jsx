...
export default function Tights() {
  ...
  const product = {
    id: 150,
    name: "Tights 65948U-060 Unisex",
    price: 25.50,
    size: selectedSize,
    quantity: quantity,
    image: "https://www.sportline.com.gt/media/catalog/product/6/5/65948u-060_frontf1-001.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/6/5/65948u-060_frontf1-001.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
            thumbnail
          />
        </Col>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>These versatile socks are designed to meet the demands of athletes and active individuals alike. Made from high-quality, breathable fabric, they ensure excellent moisture management to keep your feet dry and comfortable during any activity. The cushioned footbed provides enhanced shock absorption and comfort, while the reinforced heel and toe areas offer increased durability and long-lasting wear. The snug fit and ribbed cuffs keep the socks securely in place, preventing slipping and ensuring optimal support. Perfect for training, sports, or everyday wear, the 65948U-060 Unisex Socks are a reliable choice for anyone seeking comfort and performance in their footwear.</p>
                  </td>
                </tr>
              )}
              <tr>
