...
export default function SocksFut() {
  ...
  const product = {
    id: 145,
    name: "Football Socks Unisex",
    price: 25.50,
    size: selectedSize,
    quantity: quantity,
    image: "https://www.sportline.com.gt/media/catalog/product/z/a/za0004-black.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
  };
  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={6}>
          <Image
            src="https://www.sportline.com.gt/media/catalog/product/z/a/za0004-black.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=&width=&canvas=:&format=jpeg"
            thumbnail
          />
        </Col>
          ...
          <Table bordered style={{ marginTop: '20px' }}>
            <tbody>
              ...
              {showDetails && (
                <tr>
                  <td colSpan="2">
                    <p>Enhance your game with these Unisex Football Socks. Designed for both comfort and performance, these socks are perfect for players of all levels. Made from high-quality, breathable fabric, they provide excellent moisture management to keep your feet dry and comfortable during intense matches. The cushioned footbed and reinforced heel and toe areas offer added support and durability, ensuring long-lasting wear. The snug fit helps prevent slipping, while the ribbed cuffs keep the socks securely in place. Suitable for training and match days, these football socks are an essential addition to any player's gear. Elevate your performance and stay comfortable on the field with these premium football socks.</p>
                  </td>
                </tr>
              )}
              <tr>
